      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-6 mb-10">
            <motion.span
              className="text-7xl md:text-8xl font-bold text-primary-foreground/80 select-none"
              variants={fadeUp}
            >
              4
            </motion.span>
          ...
          <motion.h1
            className="mb-4 text-3xl md:text-5xl font-semibold tracking-tight text-primary-foreground"
            variants={fadeUp}
          >
            {title}
          </motion.h1>
          ...
          <motion.p
            className="mx-auto mb-10 max-w-md text-base md:text-lg text-primary-foreground/70"
            variants={fadeUp}
          >
            {description}
          </motion.p>
          ...
          <motion.div variants={fadeUp}>
            <Button 
              className="gap-2 hover:scale-105 transition-all duration-500 cursor-pointer bg-gradient-to-r from-cyan to-primary text-primary-foreground border-none shadow-lg"
              onClick={() => navigate("/")}
            >
